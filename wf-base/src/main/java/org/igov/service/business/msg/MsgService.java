...
public class MsgService {
	...
	public static <T> IMsgObjR send(String sType, Long nID_Subject, Long nID_Server_Custom
			, String sFunction, String sHead, String sBody, String sError, Map<String, T> mParam) throws Exception {
		return send(sType, nID_Subject, nID_Server_Custom, sFunction, sHead, sBody, sError, mParam, null);
	}
	public static <T> IMsgObjR send(String sType, Long nID_Subject, Long nID_Server_Custom
			, String sFunction, String sHead, String sBody, String sError, Map<String, T> mParam, String smData) throws Exception {
		if (!isReadySendMSG) {
